        ...
        <ul class="nav navbar-nav navbar-left">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu tipe-kiri dropdown-menu-login2">
              <li><a href="<?php echo base_url(); ?>pimpinan/cetak_tujuan_tahun"><i class="fa fa-tags"></i> Cetak Laporan Per Tahun</a></li>
              <li><a href="<?php echo base_url(); ?>pimpinan/cetak_bus"><i class="fa fa-tags"></i> Cetak Data Bus</a></li>
              <li><a href="<?php echo base_url(); ?>pimpinan/cetak_loket"><i class="fa fa-tags"></i> Cetak Data Loket</a></li>
              <li><a href="<?php echo base_url(); ?>pimpinan/cetak_tujuan"><i class="fa fa-tags"></i> Cetak Data Tujuan</a></li>
            </ul>
          </li>
