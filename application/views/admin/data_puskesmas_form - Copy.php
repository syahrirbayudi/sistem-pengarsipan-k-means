              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <div class="left-inner-addon">
                    ...
                    <input type="text" name="nama_puskesmas" value="<?php echo $nama_puskesmas ?>" required class="form-control" id="inputKK" placeholder="Nama Loket" />
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <div class="left-inner-addon">
                    <i class="fa fa-building-o"></i>
                    <input type="text" name="jumlah_pasien_total" value="<?php echo $jumlah_pasien_total ?>" required class="form-control" id="inputKK" placeholder="Jumlah Penumpang" />
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label for="inputKK" class="col-sm-3 control-label">Jumlah Bus</label>
                <div class="col-sm-6">
                  <div class="left-inner-addon">
                    <i class="fa fa-building-o"></i>
                    <input type="text" name="ketersediaan_obat_total" value="<?php echo $ketersediaan_obat_total ?>" required class="form-control" id="inputKK" placeholder="Jumlah Obat" />
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <div class="left-inner-addon">
                    <i class="fa fa-building-o"></i>
                    <input type="text" name="jumlah_fasilitas_total" value="<?php echo $jumlah_fasilitas_total ?>" required class="form-control" id="inputKK" placeholder="Jumlah Fasilitas" />
                  </div>
                </div>
              </div>
